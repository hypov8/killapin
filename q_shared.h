...
#define	CVAR_NORELOAD	32	// use with CVAR_LATCH to apply change without reloading the game (requires kpded2)
...
#define SURF_SNOW		0x2000000 // actually tin (not snow)
...
#define CHAN_PVS				64	// send only to clients in PVS (kpded2)
